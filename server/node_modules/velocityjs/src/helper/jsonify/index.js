...
require('velocityjs/src/helper/jsonify/references')(Jsonify, utils);
require('velocityjs/src/helper/jsonify/jsonify')(Jsonify, utils);
require('velocityjs/src/helper/jsonify/block')(Jsonify, utils, BLOCK_TYPES);
require('velocityjs/src/compile/expression')(Jsonify, utils);
require('velocityjs/src/compile/literal')(Jsonify, utils);
require('velocityjs/src/compile/set')(Jsonify, utils);

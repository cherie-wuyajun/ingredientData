'use strict';
if (require('core-js/library/modules/_descriptors')) {
  ...
  var $typed = require('core-js/library/modules/_typed');
  var $buffer = require('core-js/library/modules/_typed-buffer');
  var ctx = require('core-js/library/modules/_ctx');
  var anInstance = require('core-js/library/modules/_an-instance');
  var propertyDesc = require('core-js/library/modules/_property-desc');
  var hide = require('core-js/library/modules/_hide');
  var redefineAll = require('core-js/library/modules/_redefine-all');
  var toInteger = require('core-js/library/modules/_to-integer');
  var toLength = require('core-js/library/modules/_to-length');
  var toIndex = require('core-js/library/modules/_to-index');
  ...
  var gOPN = require('core-js/library/modules/_object-gopn').f;
  var getIterFn = require('core-js/library/modules/core.get-iterator-method');
  var uid = require('core-js/library/modules/_uid');
  var wks = require('core-js/library/modules/_wks');
  var createArrayMethod = require('core-js/library/modules/_array-methods');
  var createArrayIncludes = require('core-js/library/modules/_array-includes');
  var speciesConstructor = require('core-js/library/modules/_species-constructor');
  var ArrayIterators = require('core-js/library/modules/es6.array.iterator');
  var Iterators = require('core-js/library/modules/_iterators');
  var $iterDetect = require('core-js/library/modules/_iter-detect');
  var setSpecies = require('core-js/library/modules/_set-species');
  var arrayFill = require('core-js/library/modules/_array-fill');
  var arrayCopyWithin = require('core-js/library/modules/_array-copy-within');
  var $DP = require('core-js/library/modules/_object-dp');
  var $GOPD = require('core-js/library/modules/_object-gopd');
  var dP = $DP.f;
  var gOPD = $GOPD.f;

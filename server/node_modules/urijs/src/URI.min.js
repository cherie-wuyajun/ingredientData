...
(function(f,n){"object"===typeof module&&module.exports?module.exports=n(require("urijs/src/punycode"),require("urijs/src/IPv6"),require("urijs/src/SecondLevelDomains")):"function"===typeof define&&define.amd?define(["urijs/src/punycode","./IPv6","./SecondLevelDomains"],n):f.URI=n(f.punycode,f.IPv6,f.SecondLevelDomains,f)})(this,function(f, n, h, k){function b(a, c){var d=1<=arguments.length,l=2<=arguments.length;if(!(this instanceof b))return d?l?new b(a,c):new b(a):new b;if(void 0===a){if(d)throw new TypeError("undefined is not a valid argument for URI");
...
(function(f,n){"object"===typeof module&&module.exports?module.exports=n(require("urijs")):"function"===typeof define&&define.amd?define(["urijs"],n):f.URITemplate=n(f.URI,f)})(this,function(f, n){function h(b){if(h._cache[b])return h._cache[b];if(!(this instanceof h))return new h(b);this.expression=b;h._cache[b]=this;return this}function k(b){this.data=b;this.cache={}}var b=n&&n.URITemplate,q=Object.prototype.hasOwnProperty,z=h.prototype,u={"":{prefix:"",separator:",",named:!1,empty_name_separator:!1,

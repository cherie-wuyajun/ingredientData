...
const Compression = require('@hapi/hapi/lib/compression');
const Config = require('@hapi/hapi/lib/config');
const Cors = require('@hapi/hapi/lib/cors');
const Ext = require('@hapi/hapi/lib/ext');
const Methods = require('@hapi/hapi/lib/methods');
const Request = require('@hapi/hapi/lib/request');
const Route = require('@hapi/hapi/lib/route');
const Toolkit = require('@hapi/hapi/lib/toolkit');

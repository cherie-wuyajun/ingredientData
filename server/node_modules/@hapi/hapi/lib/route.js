...
const Auth = require('@hapi/hapi/lib/auth');
const Config = require('@hapi/hapi/lib/config');
const Cors = require('@hapi/hapi/lib/cors');
const Ext = require('@hapi/hapi/lib/ext');
const Handler = require('@hapi/hapi/lib/handler');
const Headers = require('@hapi/hapi/lib/headers');
const Security = require('@hapi/hapi/lib/security');
const Streams = require('@hapi/hapi/lib/streams');
const Validation = require('@hapi/hapi/lib/validation');

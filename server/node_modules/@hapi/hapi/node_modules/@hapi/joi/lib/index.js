...
const Lazy = require('@hapi/joi/lib/types/lazy');
...
const internals = {
    ...
    binary: require('@hapi/joi/lib/types/binary'),
    date: require('@hapi/joi/lib/types/date'),
    func: require('@hapi/joi/lib/types/func'),
...
internals.root = function () {
    ...
    root.version = require('@hapi/joi/package.json').version;

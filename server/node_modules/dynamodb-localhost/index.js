...
var installer = require('dynamodb-localhost/dynamodb/installer'),
    starter = require('dynamodb-localhost/dynamodb/starter'),
    utils = require('dynamodb-localhost/dynamodb/utils'),
    config = require('dynamodb-localhost/dynamodb/config.json'),
    dbInstances = {};

var shortenHex = require('clean-css/lib/optimizer/level-1/shorten-hex');
var shortenHsl = require('clean-css/lib/optimizer/level-1/shorten-hsl');
var shortenRgb = require('clean-css/lib/optimizer/level-1/shorten-rgb');
var sortSelectors = require('clean-css/lib/optimizer/level-1/sort-selectors');
var tidyRules = require('clean-css/lib/optimizer/level-1/tidy-rules');
var tidyBlock = require('clean-css/lib/optimizer/level-1/tidy-block');
var tidyAtRule = require('clean-css/lib/optimizer/level-1/tidy-at-rule');

var Hack = require('clean-css/lib/optimizer/hack');
...
var formatPosition = require('clean-css/lib/utils/format-position');
var split = require('clean-css/lib/utils/split');

var serializeRules = require('clean-css/lib/writer/one-time').rules;
...
var DEFAULT_ROUNDING_PRECISION = require('clean-css/lib/options/rounding-precision').DEFAULT;

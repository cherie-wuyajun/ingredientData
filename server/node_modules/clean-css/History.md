...
* Fixed tests, [package.json](/server/package.json) for development, and regex
...
* Updated repository location and author information in [package.json](/server/package.json).

...
const seeder = require("serverless-dynamodb-local/src/seeder.js");
const Plugin = require("serverless-dynamodb-local");

const serverlessMock = require("serverless-dynamodb-local/test/serverlessMock");
